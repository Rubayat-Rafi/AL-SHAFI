    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">{products.length} {products.length === 1 ? 'item' : 'items'} in your cart</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                        <div className="flex-1">
                          <h3 className="text-lg sm:text-xl font-semibold text-gray-900 line-clamp-2 hover:text-red-600 transition-colors">
                            {product.productName}
                          </h3>
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 lg:sticky lg:top-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between items-center text-base sm:text-lg py-3 border-b border-gray-100">
                  <span className="text-gray-600 flex items-center">
                    ...
                    Subtotal ({products.length} {products.length === 1 ? 'item' : 'items'})
                  </span>
                ...
                <div className="flex justify-between items-center text-base sm:text-lg py-3 border-b border-gray-100">
                  ...
                  <span className="text-sm text-gray-500 italic">At checkout</span>
                </div>
              ...
              <Link href={"/product/checkout"} className="w-full py-4 bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold rounded-xl hover:from-red-700 hover:to-red-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center group">
